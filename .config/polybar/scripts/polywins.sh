...
separator=""
show="window_class" # options: window_title, window_class, window_classname, icon
forbidden_classes="Polybar"
empty_desktop_message="Astrothunder"
  ...
  while IFS="[ .\.]" read -r wid ws cname cls host title; do
    ...
    *$cls*) continue ;;
    ...
    "icon")
      case "$cls" in
      Alacritty) w_name='' ;;
      Brave-browser) w_name='' ;;
      KotatogramDesktop) w_name='' ;;
      Thunar) w_name='' ;;
      *) w_name="$cls" ;;
      esac
      ;;
